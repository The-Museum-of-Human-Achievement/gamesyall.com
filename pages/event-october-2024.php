...
$headImage = "/img/event-img/GY-Banner-Oct-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/img/event-img/GY-Banner-Oct-24.png" alt="The Museum of Human Achievement presents, Games Y'all October Meetup">
        </div>
