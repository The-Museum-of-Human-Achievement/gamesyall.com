...
<!--Sunsear: Avian Combat card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/img/Archived-img/April-2024/games/sunsear.png" alt="- A promotional image for Sunsear: Avian Combat"> 
              </div>  
    ...
    <br> - Withstand foes for 7 minutes, and then take down the region’s Flagship
<br><br>
...
<!--Waiting Room Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/img/Archived-img/April-2024/games/waiting-room.png" alt="- A promotional image for Waiting Room"> 
              </div>  
...
<!--Untitled (Dragon Warrior glitches) card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/img/Archived-img/April-2024/games/nilson-carrol.png" alt="- A promotional image for Untitled (Dragon Warrior glitches)"> 
              </div>  

              <!--Game Text-->
              <div>
                <h4>Untitled (Dragon Warrior glitches)</h4>
                <p>Untitled (Dragon Warrior glitches) is an evolving HTML hypertext collection of captured handmade hex glitches from the NES titles Dragon Warrior II, III, and IV paired with prose poems that explore game mechanics, narratives, and genre legacies, queering each through the glitch process. Themes questioned include heteronormativity, binary thinking, colonization, and the neoliberal values inherent in these and all games’ mechanics and goals. Not only are the games’ digital/physical boundaries broken and expanded, but the implied ones, too. The myth of the hero is shattered, the protagonist finally made vulnerable.
                <br><br>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/img/Archived-img/April-2024/photos/apr-gy-photo-1.png" style="width: 375px; height: 375px;"> 
                <img src="/img/Archived-img/April-2024/photos/apr-gy-photo-2.png" style="width: 375px; height: 375px;"> 
                <img src="/img/Archived-img/April-2024/photos/apr-gy-photo-3.png" style="width: 375px; height: 375px;"> 
                <img src="/img/Archived-img/April-2024/photos/apr-gy-photo-4.png" style="width: 375px; height: 375px;">
                <img src="/img/Archived-img/April-2024/photos/apr-gy-photo-5.png" style="width: 375px; height: 375px;"> 
                <img src="/img/Archived-img/April-2024/photos/apr-gy-photo-6.png" style="width: 375px; height: 375px;">
            </div>
        </div>
    </div>
