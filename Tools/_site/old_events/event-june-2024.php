...
$headImage = "/images/event-img/GY-Banner-June-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-June-24.png" alt="The Museum of Human Achievement presents, Games Y'all June Meetup">
        </div>
...
<!--Comic Book Boom! card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/comic-book-boom.jpg" alt="A promotional image for Comic Book Boom!"> 
              </div>  
...
<!--Frankenfur! card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/frankenfur.png" alt="A promotional image for Frankenfur!"> 
              </div>  
...
<!--The DUNGENERATOR: DIE in a Dungeon Game-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/close-monsters.jpg" alt="A promotional image for The DUNGENERATOR: DIE in a Dungeon"> 
              </div>  
...
<!--ALTARSHOCK Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/altar-shock.png" alt="A promotional image for ALTARSHOCK"> 
              </div>  
...
<!--Lisa Hut's Memory Palace card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/memory-palace.png" alt="A promotional image for Lisa Hut's Memory Palace"> 
              </div>  
...
<!--TITANOMACHY: Dreams of the Hue Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/tdoth.jpg" alt="A promotional image for TITANOMACHY: Dreams of the Hue"> 
              </div>  
              ...
              <div>
                ...
                <div class="dev-social">
                  ...
                  <a href="https://www.tumblr.com/tdoth">
                    <img src="/images/Social-buttons/tumblr-button.png" style="width: 64px; height: auto;">
                  </a>
                </div>
              </div>
            </div>
...
<!--Power Creeps card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/June-2024/games/power-creeps.PNG" alt="A promotional image for Power Creeps"> 
              </div>  
