...
$headImage = "/images/event-img/GY-Banner-May-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-May-24.png" alt="The Museum of Human Achievement presents, Games Y'all May Meetup">
        </div>
...
<!--Teddy's Inferno card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/teddy-inferno.png" alt="- A promotional image for Teddy's Inferno"> 
              </div>  
...
<!--Piroot Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/piroot.png" alt="- A promotional image for Piroot"> 
              </div>  
...
<!--Chained to the Moon card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/chained-to-the-moon.png" alt="- A promotional image for Chained to the Moon"> 
              </div>  
...
<!--Astro Duel 2 Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/astro-duel-ii.png" alt="- A promotional image for Astro Duel 2"> 
              </div>  
...
<!--Every Letter card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/every-letter.png" alt="- A promotional image for Every Letter"> 
              </div>  
...
<!--Oblivion Eve Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/oblivion-eve.gif" alt="- A promotional image for Oblivion Eve"> 
              </div>  
...
<!--Meet Me on the Deep Net card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/lizz-thabet.png" alt="- A promotional image for Meet Me on the Deep Net"> 
              </div>  
...
<!--Another Crab's Treasure Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/May-2024/games/aggro-crab.png" alt="A promotional image for Another Crab's Treasure"> 
              </div>  
    ...
    <div class="row">-
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/images/Archived-img/May-2024/photos/may-gy-photo-1.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/May-2024/photos/may-gy-photo-2.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/May-2024/photos/may-gy-photo-3.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/May-2024/photos/may-gy-photo-4.png" style="width: 375px; height: 375px;">
                <img src="/images/Archived-img/May-2024/photos/may-gy-photo-5.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/May-2024/photos/may-gy-photo-6.png" style="width: 375px; height: 375px;">
            </div>
        </div>
    </div>
