...
$headImage = "/images/event-img/GY-Banner-Aug-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-Aug-24.png" alt="The Museum of Human Achievement presents, Games Y'all August Meetup">
        </div>
...
<!--Dance Machine 2000 card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/dance-machine.png" alt="A promotional image for the Dance Machine 2000"> 
              </div>  
...
<!--Murder at the Magic Rave Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/magic-rave.png" alt="A promotional image for Murder at the Magic Rave"> 
              </div>  
...
<!--Cute Patoots card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/cute-patoots.png" alt="A promotional image for Cute Patoots"> 
              </div>  
...
<!--UPDOG Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/updog.png" alt="A promotional image for UPDOG"> 
              </div>  
...
<!--Rollin' Along card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/rollin-along.png" alt="A promotional image for Rollin' Along"> 
              </div>  
...
<!--Hostyle Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/Hostyle.png" alt="A promotional image for Hostyle"> 
              </div>  
...
<!--Prometheus Unbound card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/August-2024/games/prometheus-unbound.png" alt="A promotional image for Prometheus Unbound"> 
              </div>  
    ...
    <div class="row">-
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/images/Archived-img/August-2024/photos/aug-gy-photo-1.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/June-2024/photos/aug-gy-photo-2.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/June-2024/photos/aug-gy-photo-3.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/June-2024/photos/aug-gy-photo-4.png" style="width: 375px; height: 375px;">
                <img src="/images/Archived-img/June-2024/photos/aug-gy-photo-5.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/June-2024/photos/aug-gy-photo-6.png" style="width: 375px; height: 375px;">
            </div>
        </div>
    </div>
