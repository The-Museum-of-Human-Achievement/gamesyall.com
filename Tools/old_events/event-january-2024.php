...
$headImage = "/images/event-img/GY-Banner-Jan-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-Jan-24.png" alt="The Museum of Human Achievement presents, Games Y'all January Meetup">
        </div>
...
<h5>Games Y'all</h5>
 ...
 <!--HouseKeeping card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/housekeeping.png" alt="- A promotional image for House Keeping">
                </div>  
 ...
 <!--don't rock the boat card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/rock-boat.jpeg" alt="- A promotional image for don't rock the boat"> 
              </div>  
 ...
 <!--1 Friend Online card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/one-friend.png" alt="- A promotional image for 1 Friend Online">
                </div>  
 ...
 <!--Project: Petra card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/project-petra.png" alt="- A promotional image for Project: Petra"> 
              </div>  
...
<!--Zombeats card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/zombeats.png" alt="- A promotional image for Zombeats">
                </div>  
 ...
 <!--Ludus card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/ludus.png" alt="- A promotional image for Ludus"> 
              </div>  
...
<!--Trend Watch 2024 card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/trend-watch-2024.jpg" alt="- A promotional image for Trend Watch 2024"> 
              </div>  
              ...
              <div>
                ...
                <div class="dev-social">
                  ...
                  <a href="https://www.instagram.com/horsemisterys/">
                    <img src="/images/Social-buttons/instagram-button.png" style="width: 64px; height: auto;">
                  </a>
                </div>
              </div>
            </div>
...
<!--Slay the Princess card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/January-2024/games/slay-the-princess.jpeg" alt="- A promotional image for Slay the Princess">
                </div>  
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/images/Archived-img/January-2024/photos/jan-gy-photo-1.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/January-2024/photos/jan-gy-photo-2.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/January-2024/photos/jan-gy-photo-3.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/January-2024/photos/jan-gy-photo-4.jpg" style="width: 375px; height: 375px;">
                <img src="/images/Archived-img/January-2024/photos/jan-gy-photo-5.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/January-2024/photos/jan-gy-photo-6.jpg" style="width: 375px; height: 375px;">
            </div>
        </div>
    </div>
