...
$headImage = "/images/event-img/GY-Banner-Sep-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-Sep-24.png" alt="The Museum of Human Achievement presents, Games Y'all September Meetup">
        </div>
...
<!--Wormspell card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/September-2024/games/wormspell.png" alt="A promotional image for Wormspell"> 
              </div>  
...
<!--Oblivion Eve Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/September-2024/games/oblivion-eve.png" alt="A promotional image for Oblivion Eve"> 
              </div>  
 ...
 <!--Time Teddy card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/September-2024/games/time-teddy.png" alt="A promotional image for Time Teddy"> 
              </div>  
...
<!--Hidden in my Paradise Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/September-2024/games/hidden-paradise.jpg" alt="A promotional image for Hidden in my Paradise"> 
              </div>  
 ...
 <!--Revision on Reunification card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/September-2024/games/revision-reunification.png" alt="A promotional image for Revision on Reunification"> 
              </div>  
    ...
    <div class="row">-
        <div class="col-12">
            ...
            <div class="flex-container-row">
                ...
                <img src="/images/Archived-img/September-2024/photos/sep-gy-photo-2.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/September-2024/photos/sep-gy-photo-3.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/September-2024/photos/sep-gy-photo-4.png" style="width: 375px; height: 375px;">
                <img src="/images/Archived-img/September-2024/photos/sep-gy-photo-5.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/September-2024/photos/sep-gy-photo-6.png" style="width: 375px; height: 375px;">
            </div>
        </div>
    </div>
