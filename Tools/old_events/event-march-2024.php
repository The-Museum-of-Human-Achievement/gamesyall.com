...
$headImage = "/images/event-img/GY-Banner-Mar-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-Mar-24.png" alt="The Museum of Human Achievement presents, Games Y'all March Meetup">
        </div>
...
<!--Obsolete Adapter card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/obsolete-adapter.png" alt="- A promotional image for Obsolete Adapter"> 
              </div>  
...
<!--ILIAGC: I Live In A Graphing Calculator card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/iliagc.png" alt="- A promotional image for ILIAGC: I Live In A Graphing Calculator"> 
              </div>  
...
<!--Cows Vs Aliens card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/cow-aliens.png" alt="- A promotional image for Cows Vs Aliens"> 
              </div>  
...
<!--Book of Five Rings card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/book-of-five-rings.jpg" alt="- A promotional image for Book of Five Rings"> 
              </div>  
...
<!--Classifieds for Poets card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/classifieds-for-poets.png" alt="A promotional image for Classifieds for Poets"> 
              </div>  
...
<!--All About Computer Love card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/computer-love.png" alt="- A promotional image for All About Computer Love"> 
              </div>  
 ...
 <!--Pacific Drive card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/March-2024/games/pacific-drive.jpeg" alt="A promotional image for Pacific Drive"> 
              </div>  
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/images/Archived-img/March-2024/photos/mar-gy-photo-1.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/March-2024/photos/mar-gy-photo-2.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/March-2024/photos/mar-gy-photo-3.jpg" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/March-2024/photos/mar-gy-photo-5.jpg" style="width: 375px; height: 375px;"> 
            </div>
        </div>
    </div>
