...
$headImage = "/images/event-img/GY-Banner-Nov-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-Nov-24.png" alt="The Museum of Human Achievement presents, Games Y'all November Meetup">
        </div>
...
<!--Space Boat card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/November-2024/games/space-boat.png" alt="A promotional image for Space Boat"> 
              </div>  
              ...
              <div>
                ...
                <div class="dev-social">
                  <a target="_blank" href="https://discord.gg/JadgAk7KT3">
                    <img src="/images/Social-buttons/discord-button.png" style="width: 64px; height: auto;" alt="A link to the Space Board Discord server.">
                  </a>  
                  <a target="_blank" href="https://twitter.com/RecombobulatorG">
                    <img src="/images/Social-buttons/twitter-button.png" style="width: 64px; height: auto;" alt="A link to the Recombobulator Games twitter">
                  </a>
                </div>
              </div>
            </div>
...
<!--Dawnfolk Card-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/November-2024/games/dawnfolk.png" alt="A promotional image for Dawnfolk"> 
              </div>  
              ...
              <div>
                ...
                <div class="dev-social">
                  <a target="_blank" href="https://darenn.itch.io/dawnfolk">
                    <img src="/images/Social-buttons/itch-button.png" style="width: 64px; height: auto;" alt="A link to the Dawnfolk Itch page">
                  </a>
                  <a target="_blank" href="https://www.instagram.com/darennkeller/">
                  <img src="/images/Social-buttons/instagram-button.png" style="width: 64px; height: auto;" alt="A link to Daren Keller's Instagram">
                </a>
                </div>
              </div>
            </div>
...
<div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/November-2024/games/upheaval.png" alt="A promotional image for Upheaval"> 
              </div>  
   ...
   <!--Dev Text-->
              <div>
                ...
                <div class="dev-social">
                  <a target="_blank" href="https://leonegaming.itch.io/upheaval">
                    <img src="/images/Social-buttons/itch-button.png" style="width: 64px; height: auto;" alt="A link to the Upheaval Itch page">
                  </a>
                  <a target="_blank" href="https://upheavalgame.com/discord">
                    <img src="/images/Social-buttons/discord-button.png" style="width: 64px; height: auto;" alt="A link to Upheaval Discord server">
                  </a>
                  <a target="_blank" href="https://bsky.app/profile/alexleone.bsky.social">
                    <img src="/images/Social-buttons/bluesky-button.png" style="width: 64px; height: auto;" alt="A link to Alex Leone's Blue Sky page">
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/November-2024/games/fetch-quest.png" alt="A promotional image for Fetch Quest"> 
              </div>  
              ...
              <div>
                ...
                <div class="dev-social">
                  <a target="_blank" href="https://bsky.app/profile/delaneyb.bsky.social">
                    <img src="/images/Social-buttons/bluesky-button.png" style="width: 64px; height: auto;" alt="A link to the Delaney Bannon's Blue Sky page">
                  </a>
                  <a target="_blank" href="https://delaneyb.itch.io/">
                  <img src="/images/Social-buttons/itch-button.png" style="width: 64px; height: auto;" alt="A link to Delaney Bannon's Itch page">
                </a>
                </div>
              </div>
            </div>
        ...
        <!--TTAP card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/November-2024/games/ttap.png" alt="A promotional image for Space Boat"> 
              </div>  
    ...
    <div class="row">-
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/images/Archived-img/November-2024/photos/nov-gy-photo-1.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/November-2024/photos/nov-gy-photo-2.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/November-2024/photos/nov-gy-photo-3.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/November-2024/photos/nov-gy-photo-4.png" style="width: 375px; height: 375px;">
                <img src="/images/Archived-img/November-2024/photos/nov-gy-photo-5.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/November-2024/photos/nov-gy-photo-6.png" style="width: 375px; height: 375px;">
