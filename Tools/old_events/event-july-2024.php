...
$headImage = "/images/event-img/GY-Banner-July-24.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <img src="/images/event-img/GY-Banner-July-24.png" alt="The Museum of Human Achievement presents, Games Y'all July Meetup">
        </div>
...
<!--Swashbucklin Summit card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/swashbucklin.png" alt="A promotional image for Swashbucklin Summit"> 
              </div>  
...
<!--Sun Is Dead Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/sun-is-dead.png" alt="A promotional image for Sun Is Dead"> 
              </div>  
...
<!--Lemonade Time! card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/lemonade-time.jpg" alt="A promotional image for Lemonade Time!"> 
              </div>  
...
<!--Infinite Library Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/infinite-library.png" alt="A promotional image for Infinite Library"> 
              </div>  
...
<!--Bridgebourn card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/bridgebourn.png" alt="A promotional image for Bridgebourn"> 
              </div>  
...
<!--Research Notebook Game-->
          <div class="row" style="background-color: #F2D335; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/research-notebook.png" alt="A promotional image for Research Notebook"> 
              </div>  
...
<!--Caribbean Dominoes card-->
          <div class="row" style="background-color: #9BE9FF; border-radius: 10px; margin-bottom: 25px;">
            <div class="game-card-long">
              <div>
                <img src="/images/Archived-img/July-2024/games/caribbean-dominoes.png" alt="A promotional image for Caribbean Dominoes"> 
              </div>  
              ...
              <div>
                ...
                <div class="dev-social">
                  ...
                  <a href="https://discord.gg/m4hkEBfzkR">
                    <img src="/images/Social-buttons/discord-button.png" style="width: 64px; height: auto;">
                  </a>
                </div>
              </div>
            </div>
    ...
    <div class="row">-
        <div class="col-12">
            ...
            <div class="flex-container-row">
                <img src="/images/Archived-img/July-2024/photos/july-gy-photo-1.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/July-2024/photos/july-gy-photo-2.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/July-2024/photos/july-gy-photo-3.png" style="width: 375px; height: 375px;"> 
                <img src="/images/Archived-img/July-2024/photos/july-gy-photo-4.png" style="width: 375px; height: 375px;">
                <img src="/images/Archived-img/July-2024/photos/july-gy-photo-5.png" style="width: 375px; height: 375px;"> 
            </div>
        </div>
    </div>
