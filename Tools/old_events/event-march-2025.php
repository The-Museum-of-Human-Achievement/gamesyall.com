...
$headDescription = "Games Y'all March Meetup";
 $headImage = "/images/event-img/GY-Banner-Mar-25.png"; // this is optional! only needed if the page has an image
...
<body>
    ...
    <div class="row">    
        ...
        <div class="col-8">
            ...
            <!-- TODO: update image -->
            <img src="/images/event-img/GY-Banner-Mar-25.png" alt="EGaDS in collaboration with Games Y'all presents, GDC squared">
        </div>
