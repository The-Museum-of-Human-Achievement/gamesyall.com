    ...
    <div class="row">    
        ...
        <p>
          ...
          The playbooks are all below the data from these is being pulled from this<a href="https://docs.google.com/spreadsheets/d/1Y0uecFSYUsVOOFncs_mWSXvMRzwkKJt4tBupt7AaAGQ/edit?gid=0#gid=0">Google Docs spreadsheet</a>.
				<p/>
                <img src="/images/misc-img/connectiquest-how-to-play.png" alt="How to Play
Get a playbook
...
Pick a new playbook that you haven't completed yet and get to work."><br/>
    <img src="/images/misc-img/connectiquest-card-networker.png" alt="Example playbook 'The Networker' NETWORKER You are here to meet new people and make new friends. You know that ships rise together and making friends at your level is just as good as those above and below!
PRINCIPLES
